#select * from `userprofile_emailverifyrecord`;
...
#UPDATE userprofile_userprofile SET is_staff = 1 WHERE id = 5;
#UPDATE userprofile_userprofile SET is_superuser = 1 WHERE id = 2;
#UPDATE userprofile_userprofile SET left_realname_n = 999 WHERE id = 4
#UPDATE userprofile_userprofile SET left_signature_n = 999 WHERE id = 1
#UPDATE userprofile_userprofile SET left_avatar_n = 999 WHERE id = 4
#UPDATE msuser_userms SET designators = "[]" WHERE id = 2
