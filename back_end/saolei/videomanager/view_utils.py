...
def update_video_num(video: VideoModel, add=True):
    ...
    if add:
        ...
        if video.mode == "00" and video.level == 'e':
            if video.timems < 100000 and userms.video_num_limit < 1000:
                userms.video_num_limit = 1000
            if video.timems < 60000 and userms.video_num_limit < 3000:
                userms.video_num_limit = 3000
            if video.timems < 50000 and userms.video_num_limit < 5000:
                userms.video_num_limit = 5000
            if video.timems < 40000 and userms.video_num_limit < 8000:
                userms.video_num_limit = 8000
            if video.timems < 30000 and userms.video_num_limit < 10000:
