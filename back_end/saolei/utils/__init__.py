...
from .secrets_json import read_secret, write_secret
...
def get_access_token() -> str:
    ...
    """
    try:
        API_KEY = str(read_secret('client_id'))
    except Exception:
        API_KEY = input('请输入client_id：')
    try:
        SECRET_KEY = str(read_secret('client_secret'))
    except Exception:
