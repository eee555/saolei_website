<template>
    ...
    <el-dialog v-model="centerDialogVisible" :title="t('common.software.software_download')" width="50%" align-center
        draggable :lock-scroll="false">
        <ul>
            <li><a style="color: blue;" target="_blank" href="https://openms.top/download/Metaminesweeper-v3.1.9.zip">
            ...
            <li><a style="color: blue;" target="_blank" href="https://openms.top/download/Metaminesweeper-v3.1.11.zip">
            ...
            <li><a style="color: blue;" target="_blank" href="https://openms.top/download/Arbiter_0.52.3.zip">Arbiter
                    v0.52.3</a><br>
