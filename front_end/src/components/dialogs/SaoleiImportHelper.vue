...
const i18nMessages = {
    'zh-cn': { local: {
        line_1: '录像同步功能代替您从扫雷网下载录像并上传到开源扫雷网。更进一步地，开源扫雷网采信扫雷网上显示的上传时间。如果您在两个网站上传了重复的录像，开源扫雷网将采用更早的上传时间。',
        line_2: '录像同步分为两个子功能：收藏与导入。“收藏”会访问您的个人主页，收集所有录像的元数据，包括录像id、上传时间等。“导入”则直接通过录像id下载录像并通过开源扫雷网的审核流程。',
