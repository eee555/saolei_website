<template>
    <span style="align-items: center;">
        <el-link data-cy="zoomout" underline="never" :disabled="zoom <= 0.1" size="small" @click="zoom = zoom - 0.1">
            <BaseIconZoomOut />
        </el-link>
        ...
        <el-link data-cy="zoomin" underline="never" :disabled="zoom >= 4" size="small" @click="zoom = zoom + 0.1">
            <BaseIconZoomIn />
        </el-link>
    </span>
</template>
