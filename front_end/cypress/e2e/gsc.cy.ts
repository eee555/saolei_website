...
describe('GSC', () => {
    ...
    it('Tournament Page', () => {
        ...
        assertTableData([
            ...
            { 状态: '进行中', 比赛: '第4届金羊杯', 主办方: HOST.realname, 开始时间: '2000-01-01 00:00:00', 结束时间: '2000-01-02 00:00:00' },
            { 状态: '结算中', 比赛: '第3届金羊杯', 主办方: HOST.realname, 开始时间: '2000-01-01 00:00:00', 结束时间: '2100-01-01 00:00:00' },
        ]);
    });
