...
After the tournament ends, points are awarded based on rank. The formula is `50/rank`: for example, 1st place receives 50 points, 2nd place receives 25 points, and so on.
